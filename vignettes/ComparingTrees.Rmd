...
```{r part1, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/part1.png', package='IntroPhylogenetics'))
```
...
```{r part2, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/part2.png', package='IntroPhylogenetics'))
```
...
```{r part3, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/part3.png', package='IntroPhylogenetics'))
```
