...
knitr::opts_chunk$set(
  fig.path = system.file('figures', package='IntroPhylogenetics')
)
library(ape)
library(DECIPHER)
source(system.file('extdata', 'TreeLine.R', package='IntroPhylogenetics', mustWork=TRUE))
```
...
```{r toydataset, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/toydataset.png', package='IntroPhylogenetics'))
```
...
```{r upgma1, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/upgma1.png', package='IntroPhylogenetics'))
```

4.  Repeat above steps until all nodes are combined and the distance
    matrix is a single row and column.

```{r upgma4, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/upgma4.png', package='IntroPhylogenetics'))
```

```{r upgma5, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/upgma5.png', package='IntroPhylogenetics'))
```

```{r upgma6, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/upgma6.png', package='IntroPhylogenetics'))
```
...
```{r nj1, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/nj1.png', package='IntroPhylogenetics'))
```
...
```{r nj2, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/nj2.png', package='IntroPhylogenetics'))
```
...
```{r nj3, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/nj3.png', package='IntroPhylogenetics'))
```
...
```{r nj4, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/nj4.png', package='IntroPhylogenetics'))
```


```{r nj5, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/nj5.png', package='IntroPhylogenetics'))
```
...
```{r mp1, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/mp1.png', package='IntroPhylogenetics'))
```
...
```{r mp2, echo=FALSE, out.width = '90%'}
knitr::include_graphics(system.file('figures/mp2.png', package='IntroPhylogenetics'))
```
